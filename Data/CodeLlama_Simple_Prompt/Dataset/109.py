def move_one_ball(arr):
    ...
    """
    # We can use a greedy approach, always moving the smallest element to the front of the array.
    # If after N moves (where N is the length of the array), the array is sorted, then it is possible to obtain a non-decreasing order by performing right shift operations.
